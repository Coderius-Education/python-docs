...
:::tip
Wil je eerst het idee van herhaling visueel oefenen? Probeer [Lightbot](https://lightbot.lu/#/level/0) — een leuke puzzelgame die je helpt het concept van een loop beter te snappen.
:::
